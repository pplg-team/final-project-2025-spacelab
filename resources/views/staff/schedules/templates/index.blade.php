<x-app-layout :title="$title" :description="$description">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="GET" action="{{ route('staff.schedules.templates.index') }}"
                                                    ...
                                                    <td class="px-4 py-3 whitespace-nowrap">
                                                        <div class="flex items-center gap-2">
                                                            ...
                                                            @if (!$template->is_active)
                                                                <!-- Activate -->
                                                                <form method="POST"
                                                                    action="{{ route('staff.schedules.templates.activate', $template) }}"
                                                                    class="inline">
                                                                    @csrf
                                                                    <button type="submit"
                                                            ...
                                                            @else
                                                                <!-- Deactivate -->
                                                                <form method="POST"
                                                                    action="{{ route('staff.schedules.templates.deactivate', $template) }}"
                                                                    class="inline">
                                                                    @csrf
                                                                    <button type="submit"
    ...
    <x-modal name="add-template-modal" focusable>
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('staff.schedules.templates.store') }}" class="space-y-4">
                @csrf
    ...
    <script>
        ...
        function deleteTemplate(templateId, templateName) {
            ...
            form.action = `/staff/schedules/templates/${templateId}`;
