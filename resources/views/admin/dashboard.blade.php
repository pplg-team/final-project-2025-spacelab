                ...
                <div
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                                ...
                                <div
                                    ...
                                    <div class="flex-shrink-0 text-center">
                                        <div class="text-sm font-semibold text-gray-900 dark:text-white">
                                            {{ $entry['start'] ?? '-' }}</div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400">{{ $entry['end'] ?? '' }}
                                        </div>
                                    </div>
                            ...
                            @empty
                                <div class="p-4 text-sm text-gray-500 dark:text-gray-400">Tidak ada jadwal untuk hari
                                    ini.</div>
                            @endforelse
                        </div>
                        <a href="#"
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            @empty
                                <div class="p-4 text-sm text-gray-500 dark:text-gray-400">Tidak ada aktivitas terbaru
                                </div>
                            @endforelse
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                        {{ number_format($totalSubjects ?? 0) }}</p>
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                        {{ $termLabel ?? 'Tidak ada semester aktif' }}</p>
                    <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
